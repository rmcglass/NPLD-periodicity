...
## Purdue's Bell cluster. This is set for use in multiple bash scripts to submit jobs via sbatch, will run DTW on 2 sims and 34 real profiles
## Input argument should be an int that is the numer of the first sim to run. If you want to run the first and second sim, input arg should be 0. 
## If you want to run the 3rd and 4th sim, input arg should be 2. (zero indexing)
